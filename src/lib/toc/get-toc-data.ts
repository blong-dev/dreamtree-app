/**
 * Shared TOC data fetching
 *
 * Extracts getTOCData from the home page so it can be used
 * by both the dashboard and workbook pages.
 */
...
// Get TOC data for dashboard/workbook
export async function getTOCData(db: D1Database, userId: string): Promise<TOCPartData[]> {
  try {
